...
const ProductDisplay = (props) => {
  ...
  return (
    <div>
     <section className="py-12 m-10 sm:py-16"> 
      ...
      <ol role="list" className="flex items-center">
        ...
        <li className="text-left">
          <div className="flex items-center">
            ...
            <div className="-m-1">
              <Link href="#" className="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800"> SHOP </Link>
            </div>
          </div>
        </li>
        ...
        <li className="text-left">
          <div className="flex items-center">
            <span className="mx-2 text-gray-400">/</span>
            <div className="-m-1">
              <Link href="#" className="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800" aria-current="page">{product.category}</Link>
            </div>
          </div>
        </li>
        <li className="text-left">
          <div className="flex items-center">
            <span className="mx-2 text-gray-400">/</span>
            <div className="-m-1">
              <Link href="#" className="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800">{product.name}</Link>
            </div>
          </div>
        </li>
      </ol>
    ...
    <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
      <div className="lg:col-span-3 lg:row-end-1">
        <div className="lg:flex lg:items-start">
          ...
          <div className="mt-2 ml-20 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
      ...
      <div className="lg:col-span-2 mr-20 lg:row-span-2 lg:row-end-2">
        <h1 className="sm: text-2xl font-bold text-gray-900 sm:text-3xl"> {product.name} </h1>

        <div className="mt-5 flex items-center">
          <div className="flex items-center">
            <svg className="block h-4 w-4 align-middle text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div>
          ...
          <div className="mt-4 ">
                    ...
                    <div className="flex items-center mt-2 p-5">
        ...
        <div>
                    ...
                    <p className="text-gray-6000 text-sm mt-2">
        ...
        <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
          ...
          <del className='text-gray-500' ><h1 className="text-xl text-gray-500 font-bold">₹ {product.old_price}</h1></del>

          
            <h1 className="text-3xl ml-4 text-red-500 font-bold">₹ {product.new_price}</h1>
            
          </div>

          <button onClick={()=>{addToCart(product.id)}} className="inline-flex items-center justify-center rounded-md border-2 border-transparent bg-gray-900 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
